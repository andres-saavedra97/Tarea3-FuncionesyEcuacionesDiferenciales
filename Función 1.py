...
y = asarray([3*np.sin(np.pi*i)  for i in x]) #Se define la función.
...
model.compile(loss='mse', optimizer='adam') #Se define la función de perdida y el optimizador.
...
pyplot.scatter(x_plot,y_plot, color='green', label='Solución Actual')
pyplot.scatter(x_plot,yhat_plot,color='blue', label='Solución predecida')
